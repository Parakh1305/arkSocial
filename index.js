...
//MESSAGES
const messagesNotification = document.querySelector('#messages-notifications');    //Variable for selecting messages notification count
...
// highlight messages card when messges menu item is clicked
